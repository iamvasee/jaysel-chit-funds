...
export default function Footer() {
  ...
  const companyInfo = {
    address: "Drno 193h, Bazzar, Mulanur, Erode, Dharapuram, Tamil Nadu, India, 638106",
    phone: "+91 89765 00022",
  ...
  const links = {
    ...
    services: [
      { name: "Chit Funds", href: "#chit-funds" },
      { name: "Group Savings", href: "#group-savings" },
      { name: "Monthly Bids", href: "#monthly-bids" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              Part of the prestigious Surabhi Group, bringing over five decades of financial expertise to your doorstep.
            </p>
            <div className="space-y-3 text-gray-500">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p>Mon-Fri: {companyInfo.hours.weekday}</p>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-500 text-sm">
              <span>© {currentYear} Jaysel Chit Funds Private Limited. All rights reserved.</span>
              <span className="block md:inline md:ml-2">CIN: {companyInfo.cin}</span>
            </div>
